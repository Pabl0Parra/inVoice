...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    featureExtractionDesc: 'El sistema detecta automáticamente artículos, precios y fechas.',
  ...
  en: {
    ...
    featureExtractionDesc: 'System automatically detects items, prices, and dates.',
